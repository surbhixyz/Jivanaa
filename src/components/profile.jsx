    ...
    return (
        ...
        <div>
            ...
            <div className='profile-form'>
                ...
                <div className='header'><h1> Your Profile</h1>
                    ...
                    <div className='fields'>
                        ...
                        <fieldset>
                            ...
                            {(formData.uterusPresence === 'yes') && (
                                <div>
                                    <label id='specific-label'>Menstrual cycle information-</label>
                                    <br></br>
                                    <br></br>

                                    <label htmlFor="menstrualCycleDate">Start date of the menstrual cycle :</label>
                                    <input
                                        type="date"
                                    ...
                                    />
                                    <br></br>
                                    <label htmlFor="menstrualCycleLength">Length of the menstrual cycle :</label>
                                    <input
                                        type="text"
                            ...
                            {(formData.uterusPresence === 'yes') && (<div>
                                ...
                                {formData.cervicalCancerScreening === 'yes' && (
                                    <div>
                                        <label htmlFor="cervicalCancerScreeningResult">Result:</label>
                                        <select
                        ...
                        <fieldset>
                            ...
                            <label htmlFor="medicationsSpecificNames">Specific medication names:</label>
                            <input
                                type="text"
